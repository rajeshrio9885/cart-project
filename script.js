    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">     
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="./imageCarsouel/menCar.jpg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="./imageCarsouel/homeapplicance.jpg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
          <img src="imageCarsouel/500Food.jpeg" class="d-block w-100" alt="...">
        </div>
      </div>
...
function payNow(){
  const isCardNum1 = document.getElementsByClassName("mcv")[0].value
  const isCardNum2 = document.getElementsByClassName("mcv")[1].value
  const isCardNum3 = document.getElementsByClassName("mcv")[2].value
  const isCardNum4 = document.getElementsByClassName("mcv")[3].value
  const isCardNum = (isCardNum1+isCardNum2+isCardNum3+isCardNum4)
